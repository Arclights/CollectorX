 ...
 * {@link MovieDetailActivity} representing item details. On tablets, the
 * activity presents the list of items and item details side-by-side using two
 * vertical panes.
 * <p>
 * The activity makes heavy use of fragments. The list of items is a
 * {@link MovieListFragment} and the item details (if present) is a
...
public class MovieListActivity extends FragmentActivity implements
	...
	public void onItemSelected(String movieID) {
		if (mTwoPane) {
			...
			arguments.putString(MovieDetailFragment.ARG_ID, movieID);
			...
			detailIntent.putExtra(MovieDetailFragment.ARG_ID, movieID);
